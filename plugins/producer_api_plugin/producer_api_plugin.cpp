 ...
 */
#include <bcio/producer_api_plugin/producer_api_plugin.hpp>
...
FC_REFLECT(bcio::detail::producer_api_plugin_response, (result));
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     bcio::detail::producer_api_plugin_response result{"ok"};
