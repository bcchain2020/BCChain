 ...
 */
#include <bcio/faucet_testnet_plugin/faucet_testnet_plugin.hpp>
...
FC_REFLECT(bcio::detail::faucet_testnet_empty, );
FC_REFLECT(bcio::detail::faucet_testnet_keys, (owner)(active));
FC_REFLECT(bcio::detail::faucet_testnet_create_account_params, (account)(keys));
FC_REFLECT(bcio::detail::faucet_testnet_create_account_alternates_response, (alternates)(message));
FC_REFLECT(bcio::detail::faucet_testnet_create_account_rate_limited_response, (message));
...
struct faucet_testnet_plugin_impl {
   ...
   results_pair find_alternates(const std::string& new_account_name) {
      ...
      const bcio::detail::faucet_testnet_create_account_alternates_response response{
   ...
   results_pair create_account(const std::string& new_account_name, const fc::crypto::public_key& owner_pub_key, const fc::crypto::public_key& active_pub_key) {
      ...
      BC_ASSERT(creating_account != nullptr, transaction_exception,
      ...
      {
         bcio::detail::faucet_testnet_create_account_rate_limited_response response{
      ...
      return std::make_pair(account_created, fc::variant(bcio::detail::faucet_testnet_empty()));
   }

   results_pair create_faucet_account(const std::string& body) {
      const bcio::detail::faucet_testnet_create_account_params params = fc::json::from_string(body).as<bcio::detail::faucet_testnet_create_account_params>();
...
const key_pair faucet_testnet_plugin_impl::_default_key_pair = {"BC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3"};
