...
CHAINBASE_SET_INDEX_TYPE( bcio::account_control_history_object, bcio::account_control_history_multi_index )

FC_REFLECT( bcio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
