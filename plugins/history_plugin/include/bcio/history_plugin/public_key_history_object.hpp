...
CHAINBASE_SET_INDEX_TYPE( bcio::public_key_history_object, bcio::public_key_history_multi_index )

FC_REFLECT( bcio::public_key_history_object, (public_key)(name)(permission) )
