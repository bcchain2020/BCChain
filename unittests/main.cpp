...
//extern uint32_t BC_TESTING_GENESIS_TIMESTAMP;
...
boost::unit_test::test_suite* init_unit_test_suite(int argc, char* argv[]) {
   ...
   /*
   const char* genesis_timestamp_str = getenv("BC_TESTING_GENESIS_TIMESTAMP");
   if( genesis_timestamp_str != nullptr )
   {
      BC_TESTING_GENESIS_TIMESTAMP = std::stoul( genesis_timestamp_str );
   }
   std::cout << "BC_TESTING_GENESIS_TIMESTAMP is " << BC_TESTING_GENESIS_TIMESTAMP << std::endl;
   */
   return nullptr;
}
