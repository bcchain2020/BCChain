...
class Utils:
    ...
    GstClientPath="programs/clbc/clbc"
    MiscGstClientArgs="--no-auto-kbcd"

    GstWalletName="kbcd"
    GstWalletPath="programs/kbcd/"+ GstWalletName

    GstServerName="nodbc"
    GstServerPath="programs/nodbc/"+ GstServerName

    GstLauncherPath="programs/bcio-launcher/bcio-launcher"
    MongoPath="mongo"
    ShuttingDown=False
    CheckOutputDeque=deque(maxlen=10)

    GstBlockLogPath="programs/bcio-blocklog/bcio-blocklog"
