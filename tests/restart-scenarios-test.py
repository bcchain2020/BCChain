...
# --kill-count <nodbc instances to kill>
...
try:
    ...
    Print("Stand up BC wallet kbcd")
    accountsCount=total_nodes
    walletName="MyWallet"
    Print("Creating wallet %s if one doesn't already exist." % walletName)
    wallet=walletMgr.create(walletName, [cluster.bcioAccount,cluster.defproduceraAccount,cluster.defproducerbAccount])
    ...
    bcioAccount=cluster.bcioAccount
    ...
    if not cluster.createAccounts(bcioAccount):
    ...
    Print("nodbc instances relaunched.")
