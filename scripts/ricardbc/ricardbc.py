...
def main():
    ...
    if sys.argv[1] == 'import':
        if len(sys.argv) != 4:
            ...
            print('Usage: ./ricardgst.py import /bc/contracts/contract/mycontract.abi /bc/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) != 3:
            ...
            print('Usage: ./ricardgst.py export /bc/contracts/contract/mycontract.abi')
