...
tools do not aim to provide an optimization platform or a hibcr-level compiler
...
> Note: If you are on macOS, you will need to use CMake version 3.2 or hibcr
