...
- Feature: Adds the ability to register a shutdown handler when using the
  ...
  down of external sockets and other cleanup without hooking in to hibcr level
  WebSocket handlers.
...
- Feature: Adds a new logging policy that outputs to syslog. #386 Thank you Tom
  Hubcs for submitting the initial version of this policy.
...
- Refactors URI to be exception free and not use regular expressions. This
  ...
  C++11 usage on GCC 4.4 and hibcr and significantly reduces staticly built
  binary sizes.
