#pragma once
#include <bcio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( bcio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(bcio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(bcio::chain::transaction_receipt, (bcio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(bcio::chain::signed_block, (bcio::chain::signed_block_header), (transactions)(block_extensions) )
