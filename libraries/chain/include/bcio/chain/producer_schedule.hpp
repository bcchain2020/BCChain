...
FC_REFLECT( bcio::chain::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( bcio::chain::producer_schedule_type, (version)(producers) )
FC_REFLECT( bcio::chain::shared_producer_schedule_type, (version)(producers) )
