...
CHAINBASE_SET_INDEX_TYPE(bcio::chain::permission_object, bcio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(bcio::chain::permission_usage_object, bcio::chain::permission_usage_index)

FC_REFLECT(bcio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(bcio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(bcio::chain::permission_usage_object, (last_used))
