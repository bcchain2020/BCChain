...
#include <bcio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(bcio::chain::table_id_object, bcio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(bcio::chain::key_value_object, bcio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(bcio::chain::index64_object, bcio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(bcio::chain::index128_object, bcio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(bcio::chain::index256_object, bcio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(bcio::chain::index_double_object, bcio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(bcio::chain::index_long_double_object, bcio::chain::index_long_double_index)

FC_REFLECT(bcio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(bcio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(bcio::chain::index64_object)
REFLECT_SECONDARY(bcio::chain::index128_object)
REFLECT_SECONDARY(bcio::chain::index256_object)
REFLECT_SECONDARY(bcio::chain::index_double_object)
REFLECT_SECONDARY(bcio::chain::index_long_double_object)
