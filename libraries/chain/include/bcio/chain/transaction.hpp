...
FC_REFLECT( bcio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( bcio::chain::transaction, (bcio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
FC_REFLECT_DERIVED( bcio::chain::signed_transaction, (bcio::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( bcio::chain::packed_transaction::compression_type, (none)(zlib))
FC_REFLECT( bcio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
FC_REFLECT_DERIVED( bcio::chain::deferred_transaction, (bcio::chain::signed_transaction), (sender_id)(sender)(payer)(execute_after) )
FC_REFLECT( bcio::chain::deferred_reference, (sender)(sender_id) )
