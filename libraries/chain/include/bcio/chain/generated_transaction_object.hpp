...
CHAINBASE_SET_INDEX_TYPE(bcio::chain::generated_transaction_object, bcio::chain::generated_transaction_multi_index)

FC_REFLECT(bcio::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))