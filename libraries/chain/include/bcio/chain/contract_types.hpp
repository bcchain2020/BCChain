...
using action_name    = bcio::chain::action_name;
...
FC_REFLECT( bcio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( bcio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( bcio::chain::setabi                           , (account)(abi) )
FC_REFLECT( bcio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( bcio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( bcio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( bcio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( bcio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( bcio::chain::onerror                          , (sender_id)(sent_trx) )
