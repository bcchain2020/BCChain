...
CHAINBASE_SET_INDEX_TYPE(bcio::chain::permission_link_object, bcio::chain::permission_link_index)

FC_REFLECT(bcio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
