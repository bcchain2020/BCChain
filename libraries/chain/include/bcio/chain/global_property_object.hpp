...
#include <bcio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(bcio::chain::global_property_object, bcio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(bcio::chain::dynamic_global_property_object,
                         bcio::chain::dynamic_global_property_multi_index)

FC_REFLECT(bcio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(bcio::chain::global_property_object,
