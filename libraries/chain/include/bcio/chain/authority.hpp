...
FC_REFLECT(bcio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(bcio::chain::key_weight, (key)(weight) )
FC_REFLECT(bcio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(bcio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(bcio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
