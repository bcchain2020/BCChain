const char* const bcio_system_abi = R"=====(
{
   ...
   "____comment": "bcio.bios structs: set_account_limits, setpriv, set_global_limits, producer_key, set_producers, require_auth are provided so abi available for deserialization in future.",
   "structs": [{
      ...
      "fields": [
         ...
         {"name":"ram_bytes", "type":"uint64"},
	       {"name":"votereward", "type":"asset"},
         {"name":"prodreward", "type":"asset"}
      ]
    },{
	 ...
	 {"name":"vote_pay", "type":"asset"}
      ...
      "fields": [
         ...
         {"name":"prodtotal_bucket",             "type":"int64"},
         {"name":"pertovote_bucket",              "type":"int64"},
         {"name":"total_unpaid_blocks",           "type":"uint32"},
         {"name":"total_vote_stake",              "type":"int64"},
         ...
         {"name":"last_calculate_time",			  "type":"uint64"},
      ...
      "fields": [
         ...
         {"name":"votes_from_voters", "type":"int64"},
         {"name":"total_blocks",      "type":"uint32"},
         {"name":"votes_rate",        "type":"float64"},
         {"name":"last_vote_unclaim", "type":"int64"},
         {"name":"bunclaim",          "type":"asset"},
         {"name":"vunclaim",          "type":"asset"},
         {"name":"unclaim",           "type":"asset"},
         {"name":"cbunclaim",         "type":"asset"},
         {"name":"cvunclaim",         "type":"asset"},
         {"name":"cunclaim",          "type":"asset"},
      ]
    },{
      "name": "regproducer",
      "base": "",
