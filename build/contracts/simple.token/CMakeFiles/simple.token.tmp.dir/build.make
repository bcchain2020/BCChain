...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o: ../contracts/simple.token/simple.token.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/work/bc_install/bc/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o"
	cd /work/bc_install/bc/build/contracts/simple.token && /opt/rh/devtoolset-7/root/usr/bin/g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o -c /work/bc_install/bc/contracts/simple.token/simple.token.cpp
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.i: cmake_force
	...
	cd /work/bc_install/bc/build/contracts/simple.token && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /work/bc_install/bc/contracts/simple.token/simple.token.cpp > CMakeFiles/simple.token.tmp.dir/simple.token.cpp.i
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.s: cmake_force
	...
	cd /work/bc_install/bc/build/contracts/simple.token && /opt/rh/devtoolset-7/root/usr/bin/g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /work/bc_install/bc/contracts/simple.token/simple.token.cpp -o CMakeFiles/simple.token.tmp.dir/simple.token.cpp.s
...
contracts/simple.token/simple.token.tmp: contracts/simple.token/CMakeFiles/simple.token.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/work/bc_install/bc/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable simple.token.tmp"
	cd /work/bc_install/bc/build/contracts/simple.token && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/simple.token.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/clean:
	cd /work/bc_install/bc/build/contracts/simple.token && $(CMAKE_COMMAND) -P CMakeFiles/simple.token.tmp.dir/cmake_clean.cmake
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/depend:
	cd /work/bc_install/bc/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /work/bc_install/bc /work/bc_install/bc/contracts/simple.token /work/bc_install/bc/build /work/bc_install/bc/build/contracts/simple.token /work/bc_install/bc/build/contracts/simple.token/CMakeFiles/simple.token.tmp.dir/DependInfo.cmake --color=$(COLOR)
