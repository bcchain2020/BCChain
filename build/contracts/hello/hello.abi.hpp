...
{
  "____comment": "This file was generated by bcio-abigen. DO NOT EDIT - 2018-05-23T20:27:36",
  ...
  "ricardian_clauses": [{
      "id": "Warranty",
      "body": "WARRANTY. The invoker of the contract action shall uphold its Obligations under this Contract in a timely and workmanlike manner, using knowledge and recommendations for performing the services which meet generally acceptable standards set forth by BC.IO Blockchain Block Producers.\n\n"
    },{
      "id": "Default",
