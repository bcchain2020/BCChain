(module
 ...
 (func $realloc (param $0 i32) (param $1 i32) (result i32)
  (call $_ZN4bcio14memory_manager7reallocEPvm
   (i32.const 3908)
   (get_local $0)
   (get_local $1)
  )
 )
 (func $_ZN4bcio14memory_manager7reallocEPvm (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  ...
  (block $label$0
   (block $label$1
    (block $label$2
     ...
     (br_if $label$0
      (tee_local $4
       (call $_ZN4bcio14memory_manager6memory16realloc_in_placeEPcmPm
        (get_local $2)
        (get_local $1)
        (get_local $3)
        (i32.add
 ...
 (func $_ZN4bcio14memory_manager6memory16realloc_in_placeEPcmPm (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
