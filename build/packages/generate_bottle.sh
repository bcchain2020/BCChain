...
mkdir -p ${PROJECT}/${VERSION}/opt/bcio/lib/cmake
...
echo "class Gstio < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/bcio/bc/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/bcio/bc/releases/download/v${VERSION}\"
