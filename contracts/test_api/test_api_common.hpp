...
#ifdef DISABLE_BCLIB_SERIALIZE
#include <bciolib/serialize.hpp>
#undef BCLIB_SERIALIZE
#define BCLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  BCLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   BCLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   BCLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   BCLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
