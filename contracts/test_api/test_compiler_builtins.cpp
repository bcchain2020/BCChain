...
void test_compiler_builtins::test_multi3() {
   ...
   bcio_assert( res == -3000, "__multi3 result should be -3000" ); 
   ...
   bcio_assert( res == 900, "__multi3 result should be 900" ); 

   /*
    * test for positive values
    */
   __multi3( res, uint64_t(lhs_b), uint64_t( lhs_b >> 64 ), uint64_t(rhs_a), uint64_t( rhs_a >> 64 ) );
   bcio_assert( res == 10000, "__multi3 result should be 10000" ); 

   /*
    * test identity
    */
   __multi3( res, 1, 0, uint64_t(rhs_a), uint64_t(rhs_a >> 64) );
   bcio_assert( res == 100, "__multi3 result should be 100" );

   __multi3( res, 1, 0, uint64_t(rhs_b), uint64_t(rhs_b >> 64) );
   bcio_assert( res == -30, "__multi3 result should be -30" );
} 
...
void test_compiler_builtins::test_divti3() {
   ...
   bcio_assert( res == 33, "__divti3 result should be 33" ); 

   /*
    * test identity
    */
   __divti3( res, uint64_t(lhs_b), uint64_t( lhs_b >> 64 ), 1, 0 );
   bcio_assert( res == 100, "__divti3 result should be 100" ); 

   __divti3( res, uint64_t(lhs_a), uint64_t( lhs_a >> 64 ), 1, 0 );
   bcio_assert( res == -30, "__divti3 result should be -30" ); 
}
...
void test_compiler_builtins::test_divti3_by_0() {
   ...
   bcio_assert( false, "Should have bcio_asserted" );
}
...
void test_compiler_builtins::test_udivti3() {
   ...
   bcio_assert( res == 3402823669209384634633746074317682114_ULLL, "__udivti3 result should be 0" ); 

   __udivti3( res, uint64_t(lhs_b), uint64_t( lhs_b >> 64 ), uint64_t(rhs_b), uint64_t( rhs_b >> 64 ) );
   bcio_assert( res == 0, "__udivti3 result should be 0" ); 

   __udivti3( res, uint64_t(lhs_a), uint64_t( lhs_a >> 64 ), uint64_t(rhs_b), uint64_t( rhs_b >> 64 ) );
   bcio_assert( res == 1, "__udivti3 result should be 1" ); 
   ...
   bcio_assert( res == (unsigned __int128)-30, "__divti3 result should be -30" ); 
}
...
void test_compiler_builtins::test_lshlti3() {
   ...
   bcio_assert( res == 1, "__lshlti3 result should be 1" );


   __lshlti3( res, uint64_t(val), uint64_t(val >> 64), 1 );
   bcio_assert( res == ( 1 << 1 ), "__lshlti3 result should be 2" );

   __lshlti3( res, uint64_t(val), uint64_t( val >> 64 ), 31 );
   bcio_assert( (unsigned __int128)res == 2147483648_ULLL, "__lshlti3 result should be 2^31" );
   
   __lshlti3( res, uint64_t(val), uint64_t( val >> 64 ), 63 );
   bcio_assert( (unsigned __int128)res == 9223372036854775808_ULLL, "__lshlti3 result should be 2^63" );

   __lshlti3( res, uint64_t(val), uint64_t( val >> 64 ), 64 );
   bcio_assert( res == test_res, "__lshlti3 result should be 2^64" );

   __lshlti3( res, uint64_t(val), uint64_t( val >> 64 ), 127 );
   test_res <<= 63;
   bcio_assert( res == test_res, "__lshlti3 result should be 2^127" );

   __lshlti3( res, uint64_t(val), uint64_t( val >> 64 ), 128 );
   test_res <<= 1;
   //should rollover
   bcio_assert( res == test_res, "__lshlti3 result should be 2^128" );
}
...
void test_compiler_builtins::test_ashlti3() {
   ...
   bcio_assert( res == 1, "__ashlti3 result should be 1" );


   __ashlti3( res, uint64_t(val), uint64_t(val >> 64), 1 );
   bcio_assert( res == (1 << 1), "__ashlti3 result should be 2" );

   __ashlti3( res, uint64_t(val), uint64_t(val >> 64), 31 );
   bcio_assert( res == (__int128)2147483648_ULLL, "__ashlti3 result should be 2^31" );
   
   __ashlti3( res, uint64_t(val), uint64_t(val >> 64), 63 );
   bcio_assert( res == (__int128)9223372036854775808_ULLL, "__ashlti3 result should be 2^63" );

   __ashlti3( res, uint64_t(val), uint64_t(val >> 64), 64 );
   bcio_assert( res == test_res, "__ashlti3 result should be 2^64" );

   __ashlti3( res, uint64_t(val), uint64_t(val >> 64), 127 );
   test_res <<= 63;
   bcio_assert( res == test_res, "__ashlti3 result should be 2^127" );

   __ashlti3( res, uint64_t(val), uint64_t(val >> 64), 128 );
   test_res <<= 1;
   //should rollover
   bcio_assert( res == test_res, "__ashlti3 result should be 2^128" );
}
...
void test_compiler_builtins::test_lshrti3() {
   ...
   bcio_assert( res == test_res, "__lshrti3 result should be 2^127" );

   __lshrti3( res, uint64_t(val), uint64_t(val >> 64), 1 );
   bcio_assert( res == (__int128)85070591730234615865843651857942052864_ULLL, "__lshrti3 result should be 2^126" );

   __lshrti3( res, uint64_t(val), uint64_t(val >> 64), 63 );
   bcio_assert( res == (__int128)18446744073709551616_ULLL, "__lshrti3 result should be 2^64" );

   __lshrti3( res, uint64_t(val), uint64_t(val >> 64), 64 );
   bcio_assert( res == (__int128)9223372036854775808_ULLL, "__lshrti3 result should be 2^63" );

   __lshrti3( res, uint64_t(val), uint64_t(val >> 64), 96 );
   bcio_assert( res == (__int128)2147483648_ULLL, "__lshrti3 result should be 2^31" );

   __lshrti3( res, uint64_t(val), uint64_t(val >> 64), 127 );
   bcio_assert( res == 0x1, "__lshrti3 result should be 2^0" );
}
...
void test_compiler_builtins::test_ashrti3() {
   ...
   bcio_assert( res == -170141183460469231731687303715884105728_LLL, "__ashrti3 result should be -2^127" );

   __ashrti3(res, uint64_t(val), uint64_t(val >> 64), 1 );
   bcio_assert( res == -85070591730234615865843651857942052864_LLL, "__ashrti3 result should be -2^126" );

   __ashrti3(res, uint64_t(val), uint64_t(val >> 64), 2 );
   bcio_assert( res == test >> 2, "__ashrti3 result should be -2^125" );

   __ashrti3( res, uint64_t(val), uint64_t(val >> 64), 64 );
   bcio_assert( res == test >> 64, "__ashrti3 result should be -2^63" );

   __ashrti3( res, uint64_t(val), uint64_t(val >> 64), 95 );
   bcio_assert( res == test >> 95, "__ashrti3 result should be -2^31" );

   __ashrti3( res, uint64_t(val), uint64_t(val >> 64), 127 );
   bcio_assert( res == test >> 127, "__ashrti3 result should be -2^0" );
}
...
void test_compiler_builtins::test_modti3() {
   ...
   bcio_assert( res ==  -30, "__modti3 result should be -30" );
   ...
   bcio_assert( res ==  10, "__modti3 result should be 10" );

   __modti3( res, uint64_t(rhs_a), uint64_t(rhs_a >> 64), uint64_t(rhs_b), uint64_t(rhs_b >> 64) );
   bcio_assert( res ==  0, "__modti3 result should be 0" );
...
void test_compiler_builtins::test_modti3_by_0() {
   ...
   bcio_assert( false, "should have thrown an error" );
}
...
void test_compiler_builtins::test_umodti3() {
   ...
   bcio_assert( res ==  (unsigned __int128)-30, "__modti3 result should be -30" );
