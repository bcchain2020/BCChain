...
## bcio.system::cfgproducer    account config
...
## bcio.system::okproducer     account producer vote
...
## bcio.system::setproxy       account proxy
...
## bcio.system::unstake        account quantity 
...
## bcio.system::withdraw account
   - this action can only be triggered by bcio.system via a deferred transaction generated by unstake
   - this will generate an inline bcio.token::transfer call from=bcio.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## bcio.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## bcio.system::stakevote account amount
   - the primary currency of bcio is controlled by the token contract which enables users to transfer
...
## bcio.system::onblock   account blocktime blocknum
...
## bcio.system::freeze producer accounts true|false 
...
## bcio.system::paystandby producer
