...
struct limit_order {
   ...
   account_name owner;
      ...
      BCLIB_SERIALIZE( limit_order, (id)(price)(expiration)(owner) )
   };
   ...
   struct test_k256 {
      ...
      BCLIB_SERIALIZE( test_k256, (id)(val) )
   };
         ...
         static void on(const trigger& act)
         {
            ...
            switch(act.what)
            {
               case 0:
               {
                  ...
                  bcio::multi_index<N(orders), limit_order,
               ...
               case 1: // Test key265 secondary index
               {
                  ...
                  bcio::multi_index<N(test1), test_k256,
               ...
               break;
               default:
                  bcio_assert(0, "Given what code is not supported.");
               break;
            }
         }
   };
...
namespace multi_index_test {
   extern "C" {
      ...
      void apply( uint64_t /* receiver */, uint64_t code, uint64_t action ) {
         require_auth(code);
         bcio_assert(bcio::dispatch<snapshot_test, snapshot_test::trigger>(code, action),
                      "Could not dispatch");
      }
   }
}
