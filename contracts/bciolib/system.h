...
*
    *  @code
    *  bcio_assert(1 == 2, "One is not equal to two.");
    *  bcio_assert(1 == 1, "One is not equal to one.");
    *  @endcode
    *
    *  @param msg - a null terminated string explaining the reason for failure
    */
   void  bcio_assert( uint32_t test, const char* msg );
    ...
    */
   void  bcio_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    */
   void  bcio_assert_code( uint32_t test, uint64_t code );
...
*
    ...
    *  @endcode
    */
   [[noreturn]] void  bcio_exit( int32_t code );
