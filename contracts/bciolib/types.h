...
/**
 * @brief BCIO Public Key
 * @details BCIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief BCIO Signature
 * @details BCIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of BCIO Transaction Id
 * @details Type of BCIO Transaction Id. It is 256-bit hash
 */
