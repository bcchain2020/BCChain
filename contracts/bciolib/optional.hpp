   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { bcio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { bcio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            bcio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return bcio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline bcio::datastream<Stream>& operator>> (bcio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline bcio::datastream<Stream>& operator<< (bcio::datastream<Stream>& ds, const optional& op)
         {
