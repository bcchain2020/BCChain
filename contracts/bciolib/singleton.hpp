...
namespace  bcio {
    ...
    *  @brief Defines BCIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         BCLIB_SERIALIZE( row, (value) )
      };

      typedef bcio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            bcio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
