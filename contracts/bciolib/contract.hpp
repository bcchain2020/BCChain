 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every BCIO contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for BCIO contract.
 * @details %Base class for BCIO contract. %A new contract should derive from this class, so it can make use of BCIO_ABI macro.
 */
class contract {
   public:
      /**
