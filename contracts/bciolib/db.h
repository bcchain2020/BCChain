 ...
 *  @brief Defines an interface to BCIO database
 *  @ingroup database
 *
 *  @details
 *  BCIO organizes data according to the following broad structure:
 ...
 *  @ingroup database
 *
 *  @details Database C API provides low level interface to BCIO database.
 *
...
/**
  ...
  *  bcio_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
...
/**
  ...
  *  bcio_assert(len <= 50, "buffer to small to store retrieved record");
...
/**
  ...
  *  bcio_assert(end_itr < -1, "Charlie was not the last entry in the table");
  *  @endcode
  */
