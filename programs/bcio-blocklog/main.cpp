...
void blocklog::read_log() {
   ...
   BC_ASSERT( end, block_log_exception, "No blocks found in block log" );
   BC_ASSERT( end->block_num() > 1, block_log_exception, "Only one block found in block log" );
...
int main(int argc, char** argv)
{
   ...
   options_description cli ("bcio-blocklog command line options");
   try {
      blocklog blog;
